...
public class InfoOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String oido = request.getParameter("oid").trim();
        int oid = Integer.parseInt(oido);
        int uid = Integer.parseInt(uid1);

        List<InforOrder> list = od.getAllOrderLineByUidAndSell_id(uid, id, oid);
        ...
        Information info = pd.getInfoAccount(aid);
