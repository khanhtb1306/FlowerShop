<%-- 
    Document   : Cart
    Created on : Feb 27, 2022, 4:27:04 PM
    Author     : trinh
--%>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <div class="p-2">
                                                            ...
                                                            <div class="ml-3 d-inline-block align-middle">
                                                                <h5 class="mb-0"> <a href="detail?pid=${i.product.id}" class="text-dark d-inline-block">${i.product.name}</a></h5><span class="text-muted font-weight-normal font-italic"></span>
                                                            </div>
                                                        </div>
                                                    </th>
                                                    ...
                                                    <td class="align-middle" width="100px">
                                                        <div class="input-group quantity">
                                                            <button><a href="myCart?num=-1&id=${i.product.id}">-</a></button>
                                                            <input type="text" class="qty-input form-control" value="${i.quantity}">
                                                            <button><a href="myCart?num=1&id=${i.product.id}">+</a></button>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle"><a href="deleteCart?id=${i.product.id}" class="text-dark">
