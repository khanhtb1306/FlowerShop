...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light flex-column" style="position: absolute; left: 20px; background-color: pink">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link">Catergory</a>
                    </li>
                    <div class = "category">
                        <nav class="category-list">
                            <c:forEach items="${ListC}" var="o"> 
                                <li><a href="manager?cid=${o.cid}">${o.cname}</a> <a href="deletecategory?id=${o.cid}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></li>
                                </c:forEach>                       
                        </nav>
                    </div>
                </ul>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <a href="#addcategory"  class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Category</span></a>
